...
{
    char TestWords[] = {"TEST MODEFilter GFSKPAx PA 1dBmTESTppm"};
    u8 i = 0, j, k;
    ...
    if (LCDUpdateIDFlag == 1)
    {
        ...
        case 0x01:
            break; //VENT
        case 0x02:
            display_map_58_6(50, 63, 5, "CLOSE");
            break;
        case 0x04:
            display_map_58_6(50, 63, 5, "STOP ");
            break;
        case 0x08:
            display_map_58_6(50, 63, 5, "OPEN ");
            break;
        case 0x0C:
            break; //open+stop
        case 0x06:
